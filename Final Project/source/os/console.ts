...
module TSOS {
    ...
    export class Console {
        ...
        constructor(public currentFont = _DefaultFontFamily,
                    ...
                    public buffer = "",
                    public imageArray = [],  //holds images for backspace
                    public xArray = []) { //holds x position for backspace
        }
        ...
        public handleInput(): void {
            while (_KernelInputQueue.getSize() > 0) {
                ...
                if (this.currentXPosition > 490) {  //line wrap
                    this.advanceLine();
                }
                ...
                } else if (chr === String.fromCharCode(8)) { //handles backspacing
