...
module TSOS {
    export class ReadyQueue {
        constructor(public pidInQueue = [], public position4 = false) {
        ...
        public loadReadyQueue() {
            if (_MemoryManager.posArray[pidCounter] == 0 && _Memory.position1 == true) {
                ...
                document.getElementById("queueTable").rows[1].cells[8].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbPriority;
                document.getElementById("queueTable").rows[1].cells[9].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbLocation;
            }
            if (_MemoryManager.posArray[pidCounter] == 1 && _Memory.position2 == true) {
                ...
                document.getElementById("queueTable").rows[2].cells[8].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbPriority;
                document.getElementById("queueTable").rows[2].cells[9].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbLocation;
            }
            if (_MemoryManager.posArray[pidCounter] == 2 && _Memory.position3 == true) {
                ...
                document.getElementById("queueTable").rows[3].cells[8].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbPriority;
                document.getElementById("queueTable").rows[3].cells[9].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbLocation;
            }
            if (_MemoryManager.posArray[pidCounter] == 99 && _ReadyQueue.position4 == true) {
                ...
                document.getElementById("queueTable").rows[4].cells[8].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbPriority;
                document.getElementById("queueTable").rows[4].cells[9].innerHTML = _MemoryManager.pcbArray[pidCounter].pcbLocation;
            }
        ...
        public setReadyQueue() {
            if (_MemoryManager.posArray[pidNum] == 0 && _Memory.position1 == true) {
               ...
               // _MemoryManager.pcbArray[pidNum].pcbState = "Ready";
                ...
                document.getElementById("queueTable").rows[1].cells[8].innerHTML = _MemoryManager.pcbArray[pidNum].pcbPriority;
                document.getElementById("queueTable").rows[1].cells[9].innerHTML = _MemoryManager.pcbArray[pidNum].pcbLocation;
            ...
            if (_MemoryManager.posArray[pidNum] == 1 && _Memory.position2 == true) {
               ...
               // _MemoryManager.pcbArray[pidNum].pcbState = "Ready";
                ...
                document.getElementById("queueTable").rows[2].cells[8].innerHTML = _MemoryManager.pcbArray[pidNum].pcbPriority;
                document.getElementById("queueTable").rows[2].cells[9].innerHTML = _MemoryManager.pcbArray[pidNum].pcbLocation;
            }
            if (_MemoryManager.posArray[pidNum] == 2 && _Memory.position3 == true) {
               ...
               // _MemoryManager.pcbArray[pidNum].pcbState = "Ready";
                ...
                document.getElementById("queueTable").rows[3].cells[8].innerHTML = _MemoryManager.pcbArray[pidNum].pcbPriority;
                document.getElementById("queueTable").rows[3].cells[9].innerHTML = _MemoryManager.pcbArray[pidNum].pcbLocation;
            }
            if (_MemoryManager.posArray[pidNum] == 99 && _ReadyQueue.position4 == true) {
                ...
                document.getElementById("queueTable").rows[4].cells[8].innerHTML = _MemoryManager.pcbArray[pidNum].pcbPriority;
                document.getElementById("queueTable").rows[4].cells[9].innerHTML = _MemoryManager.pcbArray[pidNum].pcbLocation;
            }
        ...
        public finishProcess() {
            if (_MemoryManager.posArray[pidNum] == 0) {
                ...
                document.getElementById("queueTable").rows[1].cells[9].innerHTML = "--";
            }
            if (_MemoryManager.posArray[pidNum] == 1) {
                ...
                document.getElementById("queueTable").rows[2].cells[9].innerHTML = "--";
            }
