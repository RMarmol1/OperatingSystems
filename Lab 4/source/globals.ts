...
const APP_VERSION: string = "1.37";   // What did you expect?
...
var loc = "A depression. You are currently a background character in grander scheme of someone else's main story." //location for whereami
